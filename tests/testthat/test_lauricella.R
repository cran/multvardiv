...
beta2 <- 1
lambda <- c(1, 2)
lauricella2_16 <- lauricella(-beta2, 0.5, p/2, 1 - lambda[1]/lambda[2], eps = 1e-16)
...
beta2 <- 1
lambda <- c(1, 1, 2)
lauricella3_16 <- lauricella(-beta2, c(0.5, 0.5), p/2, 1 - lambda[1:2]/lambda[3], eps = 1e-16)
...
beta2 <- 1
lambda <- c(1, 1, 1, 2)
lauricella4_16 <- lauricella(-beta2, c(0.5, 0.5, 0.5), p/2, 1 - lambda[1:3]/lambda[4], eps = 1e-16)
