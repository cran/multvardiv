...
kl12_5 <- kld(Sigma1, Sigma2, distribution = "mggd", beta1 = beta1, beta2 = beta2, eps = 1e-5)
kl12_6 <- kld(Sigma1, Sigma2, distribution = "mggd", beta1 = beta1, beta2 = beta2, eps = 1e-6)
kl12_7 <- kld(Sigma1, Sigma2, distribution = "mggd", beta1 = beta1, beta2 = beta2, eps = 1e-7)
kl12_8 <- kld(Sigma1, Sigma2, distribution = "mggd", beta1 = beta1, beta2 = beta2, eps = 1e-8)
...
kl12_9 <- kld(Sigma1, Sigma2, distribution = "mggd", beta1 = beta1, beta2 = beta2, eps = 5e-9)
kl21_9 <- kld(Sigma2, Sigma1, distribution = "mggd", beta1 = beta2, beta2 = beta1, eps = 5e-9)
...
Sigma2 = matrix(c(1, 0.3, 0.2, 0, 0, 0.3, 0.5, 0.1, 0, 0,
                  ...
                  0, 0, 0, 0, 2), nrow = 5)
kl12Matlab_d5 <- 2.598290727802524
kl21Matlab_d5 <- 12.23118770757203

kl12_d5 <- kld(Sigma1, Sigma2, distribution = "mggd", beta1 = beta1, beta2 = beta2, eps = 1e-6)
kl21_d5 <- kld(Sigma2, Sigma1, distribution = "mggd", beta1 = beta2, beta2 = beta1, eps = 1e-6)

test_that("kl works (dim 5)", {
  expect_equal(attr(kl12_d5, "eps"), 1e-6)
  expect_equal(attr(kl21_d5, "eps"), 1e-6)
